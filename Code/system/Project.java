...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/logo3.jpg"));
        Image i3 = ic.getImage().getScaledInstance(700,700,Image.SCALE_DEFAULT);
