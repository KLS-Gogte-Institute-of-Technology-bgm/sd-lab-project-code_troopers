...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","Class X(%)", "Class XII(%)", "Aadhar No","Course","Department","f_id"};
    ...
    TeacherDetails(){
        ...
        l1 = new JLabel("Enter f_id to delete Faculty : ");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
                String a = t2.getText();
                String q = "delete from faculty where f_id = '"+a+"'";
