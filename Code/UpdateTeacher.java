...
class UpdateTeacher implements ActionListener{
    ...
    UpdateTeacher(){
        ...
        JLabel l1 = new JLabel("Enter faculty id to update the data of teacher");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update faculty set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"', f_id = '"+t11.getText()+"',course='"+t13.getText()+"',dept='"+t14.getText()+"' where f_id='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from faculty where f_id = '"+t12.getText()+"'";
